/**
 * 漏れ検出タブ
 * gap-detector.ts の detectGaps / summarizeGaps を使用
 */
      ...
      {summary && (
        <div className="flex items-center gap-4 px-4 py-2 bg-amber-900/20 border-b border-amber-700/30">
          ...
          <span className="text-[10px] text-zinc-400">
            missing: {summary.byGapType.missing} | no_access: {summary.byGapType.no_access}
          </span>
        ...
        <table className="text-xs border-collapse w-full">
          <thead className="sticky top-0 z-10">
            <tr className="bg-zinc-800">
              ...
              <th className="px-3 py-2 text-right text-zinc-400 font-medium border-b border-zinc-700/50">
                日数差
              </th>
            </tr>
          </thead>
